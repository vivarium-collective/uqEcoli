...
def _(mo):
    ...
    # a stochastic timeseries generator (simulation function like vEcoli)
    import numpy as np
    ...
    class Simulator:
        ...
        # ------------------------------------------------------------------ #
        # Variable metadata (for downstream labelling / plotting)
        # ------------------------------------------------------------------ #
    ...
    mo.vstack([
        mo.md(
            """
            ## 1. _"Implement uncertainty quantification framework to track prediction confidence" (RFC006 §1, MS-08.4.2)_
